  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.searchContainer}>
          ...
          <View style={styles.headerRight}>
            ...
            <TouchableOpacity onPress={toggleMenu}>
              <Ionicons name="menu-outline" size={30} color="gray" style={styles.menuIcon} />
            </TouchableOpacity>
          </View>
          {/* Menu Modal */}
        ...
        <Text style={styles.newProduct}>Thương hiệu</Text>
...
const styles = StyleSheet.create({
  ...
  image: {
    width: 150,  // Thay đổi kích thước tùy ý
    height: 50, // Thay đổi kích thước tùy ý
